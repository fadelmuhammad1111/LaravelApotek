...
<div class="container mt-3">
    ...
    <form method="GET" action="{{ route('kasir.order.index') }}" class="mb-4">
        <div class="row">
            <div class="col-md-3">
    ...
    <div class="d-flex justify-content-between mb-4 align-items-center">
        ...
        <a href="{{ route('kasir.order.create') }}" class="btn btn-primary btn-lg shadow-sm">Pembelian Baru</a>
    ...
    <table class="table table-striped table-hover align-middle shadow-sm border">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('kasir.order.download', ['id' => $item->id]) }}" class="btn btn-sm btn-outline-success">Download Struk</a>
                    {{-- Button styled to "btn-outline-success" --}}
